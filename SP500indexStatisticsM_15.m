...
% Leggi i dati dal worksheet "SP500indexM" mantenendo i nomi originali delle colonne
opts = detectImportOptions(filePath, 'Sheet', 'SP500indexM');
...
disp('Statistiche per SP500indexM:');
disp(statsTable);
...
title('Distribuzione dei Rendimenti e Curva di Gauss per SP500indexM');
xlabel('Rendimenti');
