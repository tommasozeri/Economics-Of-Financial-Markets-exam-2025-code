% Leggi il file Excel
T = readtable('NYSEBLALLMonthly.xlsx', 'VariableNamingRule', 'preserve');

% Definisci i nomi degli asset e del benchmark
assetNames = ["BANK OF AMERICA", "CHEVRON", "COCA COLA", "JOHNSON & JOHNSON", "MCDONALDS", "WALT DISNEY", "VERIZON COMMUNICATIONS"];
...
% Vista 1
P(1, assetNames=="COCA COLA") = 1; 
q(1) = 0.05;
Omega(1, 1) = 1e-3;

% Vista 2
P(2, assetNames=="BANK OF AMERICA") = 1; 
q(2) = 0.03;
Omega(2, 2) = 1e-3;

% Vista 3
P(3, assetNames=="JOHNSON & JOHNSON") = 1; 
P(3, assetNames=="MCDONALDS") = -1; 
q(3) = 0.05;
Omega(3, 3) = 1e-5;

% Vista 4
P(4, assetNames=="CHEVRON") = 1; 
P(4, assetNames=="WALT DISNEY") = -1; 
q(4) = 0.05;
Omega(4, 4) = 1e-5;
