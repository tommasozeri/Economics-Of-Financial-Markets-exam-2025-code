% Leggi il file Excel
T = readtable('NASBLSELECTEDDaily.xlsx', 'VariableNamingRule', 'preserve');
...
% Vista 1
P(1, assetNames=="BAKER HUGHES A") = 1; 
q(1) = 0.05;
Omega(1, 1) = 1e-3;

% Vista 2
P(2, assetNames=="STEEL DYNAMICS") = 1; 
q(2) = 0.03;
Omega(2, 2) = 1e-3;

% Vista 3
P(3, assetNames=="APPLOVIN A") = 1; 
...
P(4, assetNames=="COINBASE GLOBAL A") = -1; 
q(4) = 0.05;
Omega(4, 4) = 1e-5;
