function z = portafoglio2EFM
    ...
    [x, fval, exitflag, output] = fmincon(@(x) SecondaFunzObbP2EFMM_7(x), z0, A, B, Aeq, Beq, LB, UB, [], options);
    ...
    risk_free_rate = (1 + 0.02)^(1/12) - 1; % Convertito a mensile
