function z = portafoglio2EFM
    ...
    % Carica i dati dal file Excel DBEXAM.xlsx, worksheet FUNDSselectedD
    A = readtable('DBEXAM.xlsx', 'Sheet', 'FUNDSselectedD', 'ReadRowNames', true, 'VariableNamingRule', 'preserve');
    ...
    [x, fval, exitflag, output] = fmincon(@(x) secondaFunzObbP2EFMD_funds(x), z0, A, B, Aeq, Beq, LB, UB, [], options);
